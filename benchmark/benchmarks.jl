...
SUITE["transforms"]["batch-time-major"] = @benchmarkable geo2gsm($POS_TIME_MAJOR, $TIMES; dim = 1)
SUITE["transforms"]["batch-component-major"] = @benchmarkable geo2gsm($POS_COMPONENT_MAJOR, $TIMES; dim = 2)
