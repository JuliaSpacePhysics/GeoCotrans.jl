...
See [Coordinate Systems](https://juliaspacephysics.github.io/SPEDAS.jl/dev/explanations/coords/) for more information about integration with `SPEDAS.jl`.

References: [test_cotrans.py - PySPEDAS](https://github.com/spedas/pyspedas/blob/master/pyspedas/cotrans_tools/tests/test_cotrans.py)

## Setup

!!! details "Setup library dependencies"
